...
func TestCRDwithStatus(t *testing.T) {
	...
	for _, c := range crds {
		...
		expected := apiextv1beta1.JSONSchemaProps{
...
func readCRDFile(t *testing.T) []*apiextv1beta1.CustomResourceDefinition {
	...
	crds := make([]*apiextv1beta1.CustomResourceDefinition, 0)
	for {
