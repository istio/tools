...
stable_tests = http10 graceful-shutdown gateway-bouncer mysql redis rabbitmq kafka

# Tests that need no special setup
standard_tests = http10 graceful-shutdown redis rabbitmq istio-chaos multicluster-vpn kafka
