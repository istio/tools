...
new Chart(document.getElementById("cpu-client-conn-release"), {
    type: 'line',
    data: convertData({
        labels: connNum,
        datasets: [
            {
                ...
                data: cpu_client_v2_stats_wasm_both,
                fill: false
            }, {
...
new Chart(document.getElementById("cpu-client-conn-master"), {
    type: 'line',
    data: convertData({
        labels: connNum,
        datasets: [
            {
                ...
                backgroundColor: "rgba(242, 245, 66, 0.2)",
                borderColor: "rgba(242, 245, 66, 1)",
                data: cpu_client_v2_stats_wasm_both_master,
                fill: false
            }, {
                label: "v2-sd-nologging-nullvm_both",
                backgroundColor: "rgba(52, 168, 85, 0.2)",
...
new Chart(document.getElementById("cpu-server-conn-release"), {
    type: 'line',
    data: convertData({
        labels: connNum,
        datasets: [
            {
                ...
                backgroundColor: "rgba(242, 245, 66, 0.2)",
                borderColor: "rgba(242, 245, 66, 1)",
                data: cpu_server_v2_stats_wasm_both,
                fill: false
            }, {
                label: "v2-sd-nologging-nullvm_both",
                backgroundColor: "rgba(52, 168, 85, 0.2)",
...
new Chart(document.getElementById("cpu-server-conn-master"), {
    type: 'line',
    data: convertData({
        labels: connNum,
        datasets: [
            {
                ...
                backgroundColor: "rgba(242, 245, 66, 0.2)",
                borderColor: "rgba(242, 245, 66, 1)",
                data: cpu_server_v2_stats_wasm_both_master,
                fill: false
            }, {
                label: "v2-sd-nologging-nullvm_both",
                backgroundColor: "rgba(52, 168, 85, 0.2)",
