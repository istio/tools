window.generateLatencyChart = function(connNum, options) {
  ...
  p50ReleaseModesData.push(latency_mixer_clientonly_p50);
  p50ReleaseModesData.push(latency_mixer_both_p50);
  p50ReleaseModesData.push(latency_none_serveronly_p50);
  p50ReleaseModesData.push(latency_none_clientonly_p50);
  ...
  p50ReleaseModesData.push(latency_v2_clientonly_p50);
  ...
  p90ReleaseModesData.push(latency_mixer_clientonly_p90);
  p90ReleaseModesData.push(latency_mixer_both_p90);
  p90ReleaseModesData.push(latency_none_serveronly_p90);
  p90ReleaseModesData.push(latency_none_clientonly_p90);
  ...
  p90ReleaseModesData.push(latency_v2_clientonly_p90);
  ...
  p99ReleaseModesData.push(latency_mixer_clientonly_p99);
  p99ReleaseModesData.push(latency_mixer_both_p99);
  p99ReleaseModesData.push(latency_none_serveronly_p99);
  p99ReleaseModesData.push(latency_none_clientonly_p99);
  ...
  p99ReleaseModesData.push(latency_v2_clientonly_p99);
  ...
  p50ModesData.push(latency_mixer_clientonly_p50_master);
  p50ModesData.push(latency_mixer_both_p50_master);
  p50ModesData.push(latency_none_serveronly_p50_master);
  p50ModesData.push(latency_none_clientonly_p50_master);
  ...
  p50ModesData.push(latency_v2_clientonly_p50_master);
  ...
  p90ModesData.push(latency_mixer_clientonly_p90_master);
  p90ModesData.push(latency_mixer_both_p90_master);
  p90ModesData.push(latency_none_serveronly_p90_master);
  p90ModesData.push(latency_none_clientonly_p90_master);
  ...
  p90ModesData.push(latency_v2_clientonly_p90_master);
  ...
  p99ModesData.push(latency_mixer_clientonly_p99_master);
  p99ModesData.push(latency_mixer_both_p99_master);
  p99ModesData.push(latency_none_serveronly_p99_master);
  p99ModesData.push(latency_none_clientonly_p99_master);
  ...
  p99ModesData.push(latency_v2_clientonly_p99_master);
