...
//   p50ReleaseModesData.push(latency_v2_both_p50);
//
//   generateLatency("latency-p50-release", connNum, p50ReleaseModesData, options)
//
//   // p90-release
//   p90ReleaseModesData = [];
//   p90ReleaseModesData.push(latency_mixer_base_p90);
...
//   p90ReleaseModesData.push(latency_v2_both_p90);
//
//   generateLatency("latency-p90-release", connNum, p90ReleaseModesData, options)
//
//
//   // p99-release
//   p99ReleaseModesData = [];
...
//   p99ReleaseModesData.push(latency_v2_both_p99);
//
//   generateLatency("latency-p99-release", connNum, p99ReleaseModesData, options)
//
//   // p50-master
//   p50ModesData = [];
//   p50ModesData.push(latency_mixer_base_p50_master);
...
//   p50ModesData.push(latency_v2_both_p50_master);
//
//   generateLatency("latency-p50-master", connNum, p50ModesData, options)
//
//   // p90-master
//   p90ModesData = [];
//   p90ModesData.push(latency_mixer_base_p90_master);
...
//   p90ModesData.push(latency_v2_both_p90_master);
//
//   generateLatency("latency-p90-master", connNum, p90ModesData, options)
//
//
//   // p99-master
//   p99ModesData = [];
...
//   p99ModesData.push(latency_v2_both_p99_master);
//
//   generateLatency("latency-p99-master", connNum, p99ModesData, options)
// };
//
// window.generateLatency = function(chartID, connNum, modesData, options) {
//     new Chart(document.getElementById(chartID), {
//     type: 'line',
//     data: {
//         labels: connNum,
...
//                 backgroundColor: "rgba(52, 235, 219,0.2)",
//                 borderColor: "rgba(52, 235, 219,1)",
//                 data: latency_none_plaintext_both_p50,
//                 fill: false
//             }, {
//                 label: "v2-serveronly",
//                 backgroundColor: "rgba(168, 50, 168, 0.2)",
...
//                 backgroundColor: "rgba(52, 235, 219,0.2)",
//                 borderColor: "rgba(52, 235, 219,1)",
//                 data: latency_none_plaintext_both_p90,
//                 fill: false
//             }, {
//                 label: "v2-serveronly",
//                 backgroundColor: "rgba(168, 50, 168, 0.2)",
...
//                 backgroundColor: "rgba(52, 235, 219,0.2)",
//                 borderColor: "rgba(52, 235, 219,1)",
//                 data: latency_none_plaintext_both_p99,
//                 fill: false
//             }, {
//                 label: "v2-serveronly",
//                 backgroundColor: "rgba(168, 50, 168, 0.2)",
...
//                 backgroundColor: "rgba(52, 235, 219,0.2)",
//                 borderColor: "rgba(52, 235, 219,1)",
//                 data: latency_none_plaintext_both_p50_master,
//                 fill: false
//             }, {
//                 label: "v2-serveronly",
//                 backgroundColor: "rgba(168, 50, 168, 0.2)",
...
//                 backgroundColor: "rgba(52, 235, 219,0.2)",
//                 borderColor: "rgba(52, 235, 219,1)",
//                 data: latency_none_plaintext_both_p90_master,
//                 fill: false
//             }, {
//                 label: "v2-serveronly",
//                 backgroundColor: "rgba(168, 50, 168, 0.2)",
...
//                 backgroundColor: "rgba(52, 235, 219,0.2)",
//                 borderColor: "rgba(52, 235, 219,1)",
//                 data: latency_none_plaintext_both_p99_master,
//                 fill: false
//             }, {
//                 label: "v2-serveronly",
//                 backgroundColor: "rgba(168, 50, 168, 0.2)",
