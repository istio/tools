window.onload = function () {
  ...
  let chart_master_pattern_none_serveronly_p90 = constructDataSeries(master_pattern_none_serveronly_p90, master_pattern_mixer_base_p90);
  let chart_master_pattern_none_both_p90 = constructDataSeries(master_pattern_none_both_p90, master_pattern_mixer_base_p90);
  ...
  p90ModesData.push(chart_master_pattern_none_serveronly_p90);
  p90ModesData.push(chart_master_pattern_none_both_p90);
  ...
  let chart_master_pattern_none_serveronly_p99 = constructDataSeries(master_pattern_none_serveronly_p99, master_pattern_mixer_base_p99);
  let chart_master_pattern_none_both_p99 = constructDataSeries(master_pattern_none_both_p99, master_pattern_mixer_base_p99);
  ...
  p99ModesData.push(chart_master_pattern_none_serveronly_p99);
  p99ModesData.push(chart_master_pattern_none_both_p99);
