...
import (
	"istio.io/tools/protoc-gen-crds/testdata/out/clientset/versioned/scheme"
...
// ConfigV1alpha1Client is used to interact with features provided by the config.istio.io group.
type ConfigV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ConfigV1alpha1Client) Basics(namespace string) BasicInterface {
	return newBasics(c, namespace)
}
